...
from states import california, connecticut, illinois, maryland, massachusetts, michigan, newjersey, newyork, ohio, texas
...
def get_registered_states() -> list[str]:
    return ["NY", "CA", "CT", "NJ", "TX", "IL", "OH", "MI", "MA", "IN", "VA", "MD"]
